...
- [ ] **[PRIO 3]** Nella schermata di ringraziamento, mettere 3 opzioni: **Ho finito**, **Nuova prenotazione**, **Modifica prenotazione**
  ...
  - Premendo "Modifica prenotazione" l'utente va nella schermata iniziale, con già la prenotazione caricata e modificabile

- [ ] **[PRIO 4]** Aggiungere un link per contattare la scuola: si apre un box in cui inserire nome (recuperato automaticamente), recapito telefonico (recuperato automaticamente), nome allieva (recuperato automaticamente), messaggio per la scuola
